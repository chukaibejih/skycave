    ...
    <main className="relative mx-auto min-h-[100dvh] w-full max-w-6xl px-4 pb-16 sm:px-6 lg:px-8">
      ...
      <section className="grid min-h-[calc(100dvh-88px)] items-center gap-10 py-6 lg:grid-cols-[1.02fr_0.98fr] lg:py-10">
        ...
        >
          ...
          <Link
            href="/leaderboard"
            className="mt-7 inline-flex h-12 items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)]/70 px-5 text-sm font-semibold text-[var(--color-text-primary)] transition-colors active:border-[var(--color-primary)]"
          >
            <svg
              width="17"
              height="17"
