  ...
  if (room.mode === "solo") {
    ...
    return (
      <main className="mx-auto w-full max-w-6xl px-5 py-10">
        <div className="grid items-center gap-8 lg:min-h-[78vh] lg:grid-cols-[0.9fr_1.1fr]">
        <section>
          ...
          <div className="mt-8 flex flex-col gap-2.5">
            ...
            {/* Two equal secondary actions: replay this game, or head to the
                hub to pick another. "new game" used to be silent muted text. */}
        ...
        <SoloLeaderboard gameType={room.game_type} gameName={gameName} meId={meId} />
      </main>
    );
  }
