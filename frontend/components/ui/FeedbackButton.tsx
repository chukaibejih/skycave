  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[max(env(safe-area-inset-bottom),14px)] right-3 z-40 flex h-11 items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)]/90 px-4 text-sm text-[var(--color-text-secondary)] shadow-[0_6px_20px_rgba(0,0,0,0.45)] backdrop-blur-sm active:text-[var(--color-text-primary)]"
      >
        <svg
          width="16"
          height="16"
